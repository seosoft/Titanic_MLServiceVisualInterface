...
データを用意できたので、次から Azure Machine Learning Service での作業に進みます。  
まずは Titanic のデータセットを Azure Machine Learning Service の Experiment にアップロードして、[**データの分析**](./02_dataanalyze.md) を行います。